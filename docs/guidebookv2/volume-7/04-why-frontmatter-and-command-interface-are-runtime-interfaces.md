...
- **所属卷**：卷七：命令、工作流与产品层整合
- **卷内位置**：04 / 08
- **上一篇**：[卷七 03｜命令入口是怎样接进 runtime 的](./03-how-command-entry-enters-the-runtime.md)
- **下一篇**：[卷七 05｜工作流控制层是怎样在 Claude Code 里成立的](./05-how-the-workflow-control-layer-forms-in-claude-code.md)

前 03 篇已经把命令入口怎样进入 runtime 立住了。
