...
### 结论三：第 25 篇的收束点，不是“Claude Code 很开放”，而是“Claude Code 已经把扩展写进了 runtime 结构里”
...
如果第 25 篇不往上收，而只是再说一遍五组对象各有什么价值，这一卷就会留下两个问题。
...
这也是为什么第 25 篇不能逐篇复述前文。它要做的是重新建立一条更高层的因果链。
