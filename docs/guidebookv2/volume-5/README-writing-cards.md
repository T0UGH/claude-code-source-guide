...
## 18｜Claude Code 的 hooks，为什么不是挂几个脚本这么简单
...
- **禁止偷吃的相邻篇职责**：不把工具执行链细节讲成 19，不把会话生命周期链细节讲成 20。

## 19｜工具怎么跑，hooks 其实真的插得上手
...
## 20｜一轮会话怎么起、怎么进、怎么收，hooks 其实都能插手
...
- **禁止偷吃的相邻篇职责**：不把 plugin 到底是什么讲成 22，不把平台化收束讲成 23。
- **标题下导语必须立住的一句话**：
  - **前面已经有很多扩展点，不等于系统已经有了插件层。**

## 22｜plugin 到底是什么，它不是哪一种扩展点的壳
...
- **禁止偷吃的相邻篇职责**：不把 pluginLoader / schema / marketplace 的平台化收束讲成 23。
- **标题下导语必须立住的一句话**：
  - **plugin 先是统一运行时对象，后面才轮到安装、治理和分发。**

## 23｜为什么 plugins 最后会长成一层平台边界
...
- **禁止偷吃的相邻篇职责**：不把卷尾平台层总收束提前写成 24。
- **标题下导语必须立住的一句话**：
  - **plugin 不是停在能力包这一步，而是会继续长成治理和分发都围着它转的平台边界。**

---

## 24｜为什么这些扩展对象最终会收成一层平台能力
