---
title: 卷五 06｜为什么说 Claude Code 的权限系统本质上是在给 agent runtime 做分层行动边界
date: 2026-04-06
tags:
  - Claude Code
  - 源码共读
...
# 卷五 06｜为什么说 Claude Code 的权限系统本质上是在给 agent runtime 做分层行动边界

## 导读

- **所属卷**：卷五：执行边界与安全控制
- **卷内位置**：卷五 6/6
- **上一篇**：[上一篇：policy limits 是怎么把本地权限系统再往上套一层组织策略闸门的](./05-policy-limits.md)
- **下一篇**：无

这一篇作为卷五收口，把前面的权限机制重新收成一个更大的架构判断：Claude Code 的权限系统，本质上是在给 agent runtime 做分层行动边界。
