---
title: 卷二 13｜system prompt、用户上下文、系统上下文分别是什么
date: 2026-04-06
tags:
  - Claude Code
  - 源码共读
...
# 卷二 13｜system prompt、用户上下文、系统上下文分别是什么

## 导读

- **所属卷**：卷二：一条请求是怎么跑完整个系统的
- **卷内位置**：卷二 13/13
- **上一篇**：[上一篇：用一个新会话例子通俗解释 QueryEngine 主链](./12-queryengine-example-plain.md)
- **下一篇**：无

这一篇作为卷二收口，专门把主链里最容易混的三层上下文重新分开：system prompt、用户上下文、系统上下文分别是什么，各自又在请求里承担什么角色。
